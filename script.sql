CREATE DATABASE  IF NOT EXISTS `practica_evaluativa` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `practica_evaluativa`;
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
-- Host: localhost    Database: practica_evaluativa
-- ------------------------------------------------------
